...
class AppColor {
  static const Color primaryColor = Colors.black; //Color(0xFF434657);
  static const Color secondaryColor = Color(0xffe3e5f9); //Color(0xFFb39ac2);
  static const Color backgroundColor = Color(0xFFfafafc); //Color(0xFFc6c2b8)
  static const Color textColor =
      Color(0xfff6f5ff); //Color(0xFFeff2e8);   Color(0xffe3e5f9)
